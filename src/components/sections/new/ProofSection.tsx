            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <div className="text-center lg:text-left">
                  ...
                  <p className="text-sm text-gray-500 mb-8">Founder & CEO, <a href="https://podcastwhales.co/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 underline">Podcast Whales</a></p>
