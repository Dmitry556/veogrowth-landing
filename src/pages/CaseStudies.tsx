...
const CaseStudies = () => {
  useEffect(() => {
    document.title = "Veogrowth Case Studies | B2B Lead Generation Success Stories";
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <Helmet>
        ...
        <meta name="description" content="See real results from our cold email campaigns. Case studies showing how we've generated millions in pipeline and thousands of qualified meetings for B2B companies." />
