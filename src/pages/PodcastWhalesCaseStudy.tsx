    ...
    <div className="min-h-screen text-white" style={{ background: '#0a0a0a', fontFamily: "'Montserrat', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      ...
      <main className="container mx-auto px-4 sm:px-6 py-16">
        <div className="max-w-4xl mx-auto">
                ...
                <div>
                  <div className="mb-4">
                    ...
                    <p className="text-white">
                      <a href="https://podcastwhales.co/" target="_blank" rel="noopener noreferrer" className="text-teal-400 hover:text-teal-300 underline">
                        Podcast Whales
                      </a> - B2B Podcast Production Agency
                    </p>
                  </div>
                  <div className="mb-4">
                    <span className="text-teal-400 font-medium">Service:</span>
                    <p className="text-white">Full-service podcast production for B2B companies</p>
                  </div>
                </div>
                <div>
                  <div className="mb-4">
                    <span className="text-teal-400 font-medium">Target Audience:</span>
          ...
          <section className="mb-16">
            <h2 className="text-2xl font-bold mb-8">Our Three-Layer Approach for <a href="https://podcastwhales.co/" target="_blank" rel="noopener noreferrer" className="text-teal-400 hover:text-teal-300 underline">Podcast Whales</a></h2>
            ...
            <div className="mb-12">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-xl font-bold">Layer 2: Research & Creative Angles</h3>
              </div>
              
              <div className="bg-slate-800/40 rounded-2xl p-8 border border-gray-700/50">
                <p className="text-gray-300 mb-6">We analyzed each prospect and developed unique podcast angles:</p>
            ...
            <div className="mb-12">
              ...
              <div className="bg-slate-800/40 rounded-2xl p-8 border border-gray-700/50">
                <p className="text-gray-300 mb-6">
                  Instead of generic "you should start a podcast" emails, we wrote:
                </p>
                
                <div className="space-y-8">
                  <div className="bg-slate-900/50 rounded-lg p-6 border-l-4 border-teal-500">
                    <h4 className="text-teal-400 font-medium mb-3">To a CEO whose competitor has a popular podcast:</h4>
          ...
          <section className="mb-16">
            ...
            <div className="mt-8 bg-slate-800/30 rounded-2xl p-8 border border-gray-700/50">
              <h3 className="text-xl font-bold mb-4">David Hughes, Founder of <a href="https://podcastwhales.co/" target="_blank" rel="noopener noreferrer" className="text-teal-400 hover:text-teal-300 underline">Podcast Whales</a></h3>
          ...
          <section className="mb-16">
            ...
            <div className="bg-slate-800/40 rounded-2xl p-8 border border-gray-700/50">
              <p className="text-lg text-gray-300 mb-6">
                For creative services like <a href="https://podcastwhales.co/" target="_blank" rel="noopener noreferrer" className="text-teal-400 hover:text-teal-300 underline">Podcast Whales</a>, our research doesn't just identify problems — it proposes solutions so specific and compelling that prospects can't help but respond.
              </p>
